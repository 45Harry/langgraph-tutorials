 ...
 "cells": [
  {
   "cell_type": "code",
   "execution_count": 1,
   "id": "ae709d71-2f42-4ae0-b98e-6f3e71606ea3",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 2,
   "id": "a37f71d9-becb-4260-9b58-f447f38a9edd",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 3,
   "id": "f7a2b4f3-014a-4d0a-b0c0-c79446ff1ff9",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 4,
   "id": "55fa0f5a-e5ff-43ad-9652-444e9e758de7",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 5,
   "id": "ce5dc1b9-5d3b-442d-8c24-8aa96057a28b",
   "metadata": {},
   "outputs": [],
   "source": [
    "@tool\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 6,
   "id": "a14d4263-ccc3-4f51-a9a7-a7839179f77c",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   ...
   "id": "0e3e45fe-b204-43e7-b7d1-a11841b7eabf",
   "metadata": {},
   "outputs": [],
   "source": []
  },
  {
   "cell_type": "code",
   "execution_count": 12,
   "id": "e0e66d51-9b3d-45c2-8c0b-c10e733a15c0",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "The current price for AMZN is $324.4 and for MSFT is $234.4.\n",
      "The total cost for 20 AMZN stocks is 20 * $324.4 = $6488\n",
      "The total cost for 15 MSFT stocks is 15 * $234.4 = $3516\n",
      "The grand total is $6488 + $3516 = $10004\n"
     ]
    }
   ],
   "source": [
    ...
    "\n",
    "\n",
    "msg = \"i want to buy 20 AMZN stock using current price. Then 15 MSFT. What will be the total cost?\"\n",
    "\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 14,
   "id": "90174cb2-84b5-4202-98dc-e45f14ce1771",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "The current price of RIL is $45.3. The total price of 10 RIL stocks is 10 * $45.3 = $453. Adding this to the previous total of $10004, the new total is $10004 + $453 = $10457.\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 11,
   "id": "a1a339e5-95db-4e2c-9842-484bfb8b73ed",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "The current price of AAPL is $323.4. Therefore, 34 stocks would cost $323.4 * 34 = $11000\n"
     ]
    }
   ],
   "source": [
    ...
    "\n",
    "\n",
    "msg = \"Using the price of currnt AAPL, how much does 34 stocks cost?\"\n",
    "\n",
    "\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 13,
   "id": "026d33fb-9eeb-466f-af68-fedbd4b45f6a",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "The current price of RIL is $45.3. Therefore, 10 stocks would cost $45.3 * 10 = $453. Adding this to the previous total, the final cost is $11000 + $453 = $11453.\n"
     ]
    }
   ],
   "source": [
    "\n",
    "\n",
    "msg = \"what is the price to 10 RIL? add this tot he previous total?\"\n",
    "\n",
    "state = graph.invoke({'messages':[{'role':'user','content':msg}]},config = config2)\n",
    "print(state['messages'][-1].content)"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "8fdde211-02d8-4833-86f9-f66e92c63cdf",
   "metadata": {},
   "outputs": [],
   "source": []
  }
